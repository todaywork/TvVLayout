...
//                        subAdapter.notifyItemRangeChanged(getFirstVisiblePosition(),getLastVisiblePosition());
//                        break;
...
//        adapters.add(subAdapter);
        for (int i = 0; i < 12; i++) {
            ...
            subAdapter = new SubAdapter(this,helper8,new VirtualLayoutManager.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dip2px(300,this)),10,itemBeanGrid8,viewPool,onItemFocusListener);
